...
<div class="">
    ...
    <div class="car-detail gray">
        <div class="advertising">
            <div class="container">
                  <div class="banner">
                     <img src="{{ asset('assets/frontend-assets/images/banner-1.png')}}" alt="">
                 </div>
             </div>
        </div>
     </div>
             ...
             <div class="col-md-8 col-xs-12 col-sm-12">
                ...
                <div class="singlepage-detail ">
                   ...
                   <div id="single-slider" class="flexslider">
                      <ul class="slides">
                         <li><a href="images/single-page/1.jpg" data-fancybox="group"><img alt="" src="{{ asset('assets/frontend-assets/images/single-page/1.jpg')}}" /></a></li>
                         <li><a href="images/single-page/2.jpg" data-fancybox="group"><img alt="" src="{{ asset('assets/frontend-assets/images/single-page/2.jpg')}}" /></a></li>
                         <li><a href="images/single-page/3.jpg" data-fancybox="group"><img alt="" src="{{ asset('assets/frontend-assets/images/single-page/3.jpg')}}" /></a></li>
                         <li><a href="images/single-page/4.jpg" data-fancybox="group"><img alt="" src="{{ asset('assets/frontend-assets/images/single-page/4.jpg')}}" /></a></li>
                         <li><a href="images/single-page/5.jpg" data-fancybox="group"><img alt="" src="{{ asset('assets/frontend-assets/images/single-page/5.jpg')}}" /></a></li>
                         <li><a href="images/single-page/6.jpg" data-fancybox="group"><img alt="" src="{{ asset('assets/frontend-assets/images/single-page/6.jpg')}}" /></a></li>
                      </ul>
                   </div>
                   <div id="carousel" class="flexslider">
                      <ul class="slides">
                         <li><img alt="" src="{{ asset('assets/frontend-assets/images/single-page/1_thumb.jpg')}}"></li>
                         <li><img alt="" src="{{ asset('assets/frontend-assets/images/single-page/2_thumb.jpg')}}"></li>
                         <li><img alt="" src="{{ asset('assets/frontend-assets/images/single-page/3_thumb.jpg')}}"> </li>
                         <li><img alt="" src="{{ asset('assets/frontend-assets/images/single-page/4_thumb.jpg')}}"></li>
                         <li><img alt="" src="{{ asset('assets/frontend-assets/images/single-page/5_thumb.jpg')}}"></li>
                         <li><img alt="" src="{{ asset('assets/frontend-assets/images/single-page/6_thumb.jpg')}}"></li>
                      </ul>
                   </div>
                   ...
                   <div class="content-box-grid">
                      ...
                      <div class="short-features">
                         ...
                         <div class="ad-related-img">
                            <img src="{{ asset('assets/frontend-assets/images/car-img1.png')}}" alt="" class="img-responsive center-block">
                         </div>
                         <!-- Heading Area -->
                         <div class="heading-panel">
                            <h3 class="main-title text-left">
                      ...
                      <div class="panel with-nav-tabs panel-default">
                         ...
                         <div class="panel-body">
                            <div class="tab-content">
                                ...
                                <iframe src="https://www.youtube.com/embed/lr7mPzjTgC0" allowfullscreen="" height="370" ></iframe>
                               </div>
                            </div>
                         </div>
                      </div>
                      ...
                      <div class="posts-masonry">
                         <div class="ads-list-archive">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-5 no-padding">
                               ...
                               <div class="ad-archive-img">
                                  <a href="#">
                                  <img class="img-responsive" src="{{ asset('assets/frontend-assets/images/posting/10.jpg')}}" alt=""> 
                                  </a>
                               </div>
                               <!-- Img Block -->
                            </div>
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-7 no-padding">
                               ...
                               <div class="ad-archive-desc">
                                  ...
                                  <!-- Ad Features -->
                                  <ul class="add_info">
                                     <li><a href="#"><img  src="{{ asset('assets/frontend-assets/images/blog/s1.jpg')}}" alt=""></a></li>
                                     <li><a href="#"><img  src="{{ asset('assets/frontend-assets/images/blog/s1.jpg')}}" alt=""></a></li>
                                     <li><a href="#"><img  src="{{ asset('assets/frontend-assets/images/blog/s1.jpg')}}" alt=""></a></li>
                                     <li><a href="#"><img  src="{{ asset('assets/frontend-assets/images/blog/s1.jpg')}}" alt=""></a></li>
                                  </ul>
                         ...
                         <div class="ads-list-archive">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-5 no-padding">
                               ...
                               <div class="ad-archive-img">
                                  <a href="#">
                                  <img class="img-responsive" src="{{ asset('assets/frontend-assets/images/posting/14.jpg')}}" alt=""> 
                                  </a>
                               </div>
                               <!-- Img Block -->
                            </div>
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-7 no-padding">
                               ...
                               <div class="ad-archive-desc">
                                  ...
                                  <!-- Ad Features -->
                                  <ul class="add_info">
                                     <li><a href="#"><img  src="{{ asset('assets/frontend-assets/images/blog/s2.jpg')}}" alt=""></a></li>
                                     <li><a href="#"><img  src="{{ asset('assets/frontend-assets/images/blog/s1.jpg')}}" alt=""></a></li>
                                  </ul>
                                  <!-- Ad History -->
                                  <div class="clearfix archive-history">
                         ...
                         <div class="ads-list-archive">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-5 no-padding">
                               ...
                               <div class="ad-archive-img">
                                  <a href="#">
                                  <img class="img-responsive" src="{{ asset('assets/frontend-assets/images/posting/6.jpg')}}" alt=""> 
                                  </a>
                               </div>
                               <!-- Img Block -->
                            </div>
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-7 no-padding">
                               ...
                               <div class="ad-archive-desc">
                                  ...
                                  <!-- Ad Features -->
                                  <ul class="add_info">
                                     <li><a href="#"><img  src="{{ asset('assets/frontend-assets/images/blog/s3.jpg')}}" alt=""></a></li>
                                     <li><a href="#"><img  src="{{ asset('assets/frontend-assets/images/blog/s2.jpg')}}" alt=""></a></li>
                                     <li><a href="#"><img  src="{{ asset('assets/frontend-assets/images/blog/s1.jpg')}}" alt=""></a></li>
                                     <li><a href="#"><img  src="{{ asset('assets/frontend-assets/images/blog/s4.jpg')}}" alt=""></a></li>
                                  </ul>
                                  <!-- Ad History -->
                                  <div class="clearfix archive-history">
                                     <div class="last-updated">Last Updated: 1 day ago</div>
                         ...
                         <div class="ads-list-archive">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-5 no-padding">
                               ...
                               <div class="ad-archive-img">
                                  <a href="#">
                                  <img class="img-responsive" src="{{ asset('assets/frontend-assets/images/posting/2.jpg')}}" alt=""> 
                                  </a>
                               </div>
                               <!-- Img Block -->
                            </div>
                         ...
                         <div class="ads-list-archive">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-5 no-padding">
                               ...
                               <div class="ad-archive-img">
                                  <a href="#">
                                  <img class="img-responsive" src="{{ asset('assets/frontend-assets/images/posting/13.jpg')}}" alt=""> 
                                  </a>
                               </div>
                               <!-- Img Block -->
                            </div>
