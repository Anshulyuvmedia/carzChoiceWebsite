...
<div class="page-header-area-2 gray">
 ...
 <div class="main-content-area clearfix">
             ...
             <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row pricing style-3">
                   <div class="col-sm-6 col-lg-4 col-md-4">
                      ...
                      <div class="selection">
                         <a href="#" class="btn btn-block btn-theme">Select Plan <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                      </div>
                   </div>
                   <div class="col-sm-6 col-lg-4 col-md-4">
                      <div class="block featured">
                   ...
                   <div class="col-sm-6 col-lg-4 col-md-4">
                      <div class="pricing-fancy ">
                         ...
                         <div class="price-box">
                            ...
                            <a href="#" class="btn btn-block btn-theme">Submit Featured Ad</a> 
                         </div>
                      </div>
                   </div>
                   <div class="col-sm-6 col-lg-4 col-md-4">
    ...
    <section class="parallex bg-img featured-ads">
       <div class="container">
          <!-- Container -->
          <div class="container">
