                            ...
                            <div class="listingTopFilterBar">
                                <div class="col-md-12 col-xs-12 col-sm-7 ">
                                    <div class="header-listing">
                                        <div class=" mt-3">
                                            <button class="btn btn-outline btn-theme rounded-4"
                                                data-bs-target="#carfilter" data-bs-toggle="modal"> Filter by: </button>
                            ...
                            <div class="posts-masonry">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12  ">
                                    <div class="white category-grid-box-1 ">
                                        <!-- Image Box -->
                                        <div class="image"> <img alt="Carz Choice"
                                                src="{{ asset('assets/backend-assets/images/' . $row->addimage) }}"
                                                class="img-responsive"></div>
                                        <div class="ad-info-1">
                                            <ul>
                                                <li><i class="flaticon-fuel-1 fs-6"></i>{{ $row->fueltype }}</li>
                                                <li><i class="flaticon-dashboard fs-6"></i>{{ $row->kilometersdriven }} km</li>
                                                <li><i class="flaticon-engine-2 fs-6"></i>{{ $row->transmissiontype }}</li>
                                            </ul>
                                        </div>
                                        <!-- Short Description -->
                                        <div class="short-description-1 ">
                                            <h3>
                                                <a title="" href="#"> {{ $row->brandname }} {{ $row->carname }} {{ $row->carmodalname }}</a>
                                            </h3>
                                            <!-- Location -->
                                            <p class="location">
                                                <i class="fa fa-map-marker"></i>
                                                {{ $row->state }},{{ $row->district }},{{ $row->pincode }}
                                            </p>
                                            <!-- Ad Meta Stats -->
                                            <span class="ad-price">Rs. {{ $row->price }}</span>
                                            <a class="btn btn-sm btn-theme pull-right"><i class="fa fa-phone"></i> View
                                                Details.</a>
                                        </div>
                                    </div>
                                </div>
