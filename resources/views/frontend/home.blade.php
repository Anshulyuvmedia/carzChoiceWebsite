                ...
                <div class="col-md-12 col-xs-12 col-sm-12">
                   ...
                   <div class="col-md-4 col-xs-12 col-sm-6">
                      <div class="category-grid-box-1">
                         ...
                         <div class="image">
                            <img alt="Carspot" src="{{ asset('assets/frontend-assets/images/posting/2.jpg')}}" class="img-responsive">
                   ...
                   <div class="col-md-4 col-xs-12 col-sm-6">
                      <div class="category-grid-box-1">
                         ...
                         <div class="image">
                            <img alt="Carspot" src="{{ asset('assets/frontend-assets/images/posting/3.jpg')}}" class="img-responsive">
                            <div class="ribbon popular"></div>
                            <div class="price-tag">
                   ...
                   <div class="col-md-4 col-xs-12 col-sm-6">
                      <div class="category-grid-box-1">
                         ...
                         <div class="image">
                            <img alt="Carspot" src="{{ asset('assets/frontend-assets/images/posting/6.jpg')}}" class="img-responsive">
                            <div class="ribbon popular"></div>
                            <div class="price-tag">
                   ...
                   <div class="col-md-4 col-xs-12 col-sm-6">
                      <div class="category-grid-box-1">
                         ...
                         <div class="image">
                            <img alt="Carspot" src="{{ asset('assets/frontend-assets/images/posting/13.jpg')}}" class="img-responsive">
                            <div class="ribbon popular"></div>
                            <div class="price-tag">
                   ...
                   <div class="col-md-4 col-xs-12 col-sm-6">
                      <div class="category-grid-box-1">
                         ...
                         <div class="image">
                            <img alt="Carspot" src="{{ asset('assets/frontend-assets/images/posting/14.jpg')}}" class="img-responsive">
                            <div class="ribbon popular"></div>
                            <div class="price-tag">
                   ...
                   <div class="col-md-4 col-xs-12 col-sm-6">
                      <div class="category-grid-box-1">
                         ...
                         <div class="image">
                            <img alt="Carspot" src="{{ asset('assets/frontend-assets/images/posting/8.jpg')}}" class="img-responsive">
                            <div class="ribbon popular"></div>
                            <div class="price-tag">
       ...
       <div class="container">
          <div class="row">
             ...
             <div class="col-md-7 col-sm-12 col-xs-12">
                <div class="mainimage">
                   <a>
                      <img alt="" class="img-responsive" src="{{ asset('assets/frontend-assets/images/blog/1.jpg')}}">
                      <div class="overlay">
             ...
             <div class="col-md-5 col-sm-12 col-xs-12">
                <div class="newslist">
                   <ul>
                      <li>
                         <div class="imghold"> <a><img src="{{ asset('assets/frontend-assets/images/blog/s1.jpg')}}" alt=""></a> </div>
                         <div class="texthold">
                      ...
                      <li>
                         <div class="imghold"> <a><img src="{{ asset('assets/frontend-assets/images/blog/s2.jpg')}}" alt=""></a> </div>
                         <div class="texthold">
                      ...
                      <li>
                         <div class="imghold"> <a><img src="{{ asset('assets/frontend-assets/images/blog/s3.jpg')}}" alt=""></a> </div>
                         <div class="texthold">
                      ...
                      <li>
                         <div class="imghold"> <a><img src="{{ asset('assets/frontend-assets/images/blog/s4.jpg')}}" alt=""></a> </div>
                         <div class="texthold">
                            <h4><a>Audi A4 Diesel Launched In India At Rs 40.20 Lakh </a></h4>
                            <p>Audi India has launched a powerful diesel variant of its A4 sedan at Rs 40.20 la...&nbsp;</p>
                         </div>
                ...
                <div class="brand-logo-area clients-bg">
                   <div class="clients-list">
                      <div class="client-logo">
                         <a href="#"><img src="{{ asset('assets/frontend-assets/images/brands/16.png')}}" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="{{ asset('assets/frontend-assets/images/brands/2.png')}}" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="{{ asset('assets/frontend-assets/images/brands/11.png')}}" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="{{ asset('assets/frontend-assets/images/brands/4.png')}}" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="{{ asset('assets/frontend-assets/images/brands/5.png')}}" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="{{ asset('assets/frontend-assets/images/brands/6.png')}}" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="{{ asset('assets/frontend-assets/images/brands/7.png')}}" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="{{ asset('assets/frontend-assets/images/brands/8.png')}}" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="{{ asset('assets/frontend-assets/images/brands/9.png')}}" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="{{ asset('assets/frontend-assets/images/brands/17.png')}}" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                   </div>
                </div>
             </div>
          ...
          <div class="row">
             <div class="col-md-6 col-sm-6 col-xs-12 nopadding hidden-sm">
                <div class="call-to-action-img-section-right">
                   <img src="{{ asset("assets/frontend-assets/images/car-in-red.png")}}" class="wow slideInLeft img-responsive" data-wow-delay="0ms" data-wow-duration="3000ms" alt="">
                </div>
             </div>
             ...
             <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                <div class="sell-box-grid">
                   ...
                   <div class="text-center">
                      <img class="img-responsive wow slideInLeft center-block" data-wow-delay="0ms" data-wow-duration="2000ms" src="assets/frontend-assets/images/sell.png" alt="">
                   </div>
                </div>
             </div>
             <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                <div class="sell-box-grid">
                   ...
                   <div class="text-center">
                      <img class="img-responsive wow slideInRight center-block" data-wow-delay="0ms" data-wow-duration="2000ms" src="assets/frontend-assets/images/sell-1.png" alt="">
                   </div>
                </div>
             </div>
          </div>
